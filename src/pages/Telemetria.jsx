  ...
  export function Telemetria({ frota, statusLinks }) {
    ...
    // Efeito de Áudio (Sirene da Ambulância)
    useEffect(() => {
      let audioCtx = null;
      let osc = null;
      let intervalId = null;
    ...
    // Regra de dependência de link por categoria de veículo
    let dependeciaId = 3;
      ...
      <div className="container-fluid px-4 mt-4">
        ...
        <div className="row">
          {veiculosExibidos.map((veiculo, index) => {
            ...
            // Montagem da URL e formato geográfico vindo do SQLite
              ...
              <div key={veiculo.id} className="col-12 col-md-6 col-lg-4 col-xl-3 mb-4">
                <div className={`card glass-card h-100 ${!veiculoAtivo ? 'offline-mode border-danger' : ''}`}>
                  <div className="cenario">
                    ...
                    {/* Emoji do veículo transformado em link interativo para o Maps */}
                    <a
                  ...
                  <div className="card-body">
                    ...
                    <div className="row text-secondary small">
                      ...
                      <div className="col-6 mb-2 text-end">
                        ...
                        {/* Coordenada clicável para abrir no Google Maps */}
                        <a
                          href={veiculoAtivo ? urlMapa : "#"}
                          target={veiculoAtivo ? "_blank" : "_self"}
                          rel="noopener noreferrer"
                        ...
                        {/* Exibição da hora da atualização (Sync) vinda do banco */}
                        <div style={{ fontSize: '0.65rem', marginTop: '4px' }} className="text-light">
